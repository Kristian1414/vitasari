    ...
    <>
      <section className="page-header page-header--tentang">
        <div className="container">
          ...
          <p>
            Tiga dekade memanggang roti untuk keluarga Bandung, dengan resep
            yang tidak pernah kami ubah.
          </p>
        </div>
      </section>
        ...
        <div className="container about-split">
          ...
          <Reveal className="about-split__content" variant="right" delay={120}>
            ...
            <h2 className="section__title">
              Roti yang Tumbuh Bersama Pelanggannya
            </h2>
            <p>
              Vitasari Bakery lahir tahun 1991 dari dapur rumah di kawasan
              Kurdi, Bandung. Yang awalnya hanya melayani tetangga, perlahan
              jadi langganan lintas generasi: anak-anak yang dulu dibelikan roti
              coklat keju kini datang membawa anaknya sendiri.
            </p>
            <p>
              Kami masih memanggang dini hari, masih memakai butter dan keju
              yang sama, dan masih menolak memakai pengawet. Yang berubah hanya
              jumlah cabang, supaya roti hangat kami lebih mudah dijangkau dari
              mana pun di Bandung.
            </p>
